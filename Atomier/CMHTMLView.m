...
- (void)loadHtmlBody:(NSString*)html competition:(CompetitionBlock)competition withStart:(BOOL)start {
...
- (void)loadHtmlBody:(NSString*)html competition:(CompetitionBlock)competition {
    [self loadHtmlBody:html competition:competition withStart:YES];
}
